    ...
    switch(type){
        ...
        case "order":
            data = {
                ...
                icon: <ShoppingCartOutlined className='icon' style={{color:"crimson", backgroundColor:"rgba(255, 0, 0, 0.2)"}}/> 
            }
        break;
        case "earning":
            data = {
        ...
        case "balance":
            data = {
                ...
                isMoney: true,
                link : "See details",
                icon: <AccountBalanceWalletOutlined className='icon' style={{color:"crimson", backgroundColor:"rgba(255, 0, 0, 0.2)"}}/>
            }
        break;
        default:
            break;
